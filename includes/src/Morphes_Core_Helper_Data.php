...
/**
 * Generic helper functions for Morphes_Core module. This class is a must for any module even if empty.
 * @author Morphes Team
 */
class Morphes_Core_Helper_Data extends Mage_Core_Helper_Abstract {
    /**
	...
	protected function _initUrlSymbols() {
		if (!$this->_urlSymbols) {
			...
			$this->_urlSymbols['-'] = Mage::getStoreConfig('morphes_filters/seo/dash');
			$this->_urlSymbols['/'] = Mage::getStoreConfig('morphes_filters/seo/slash');
			$this->_urlSymbols['+'] = Mage::getStoreConfig('morphes_filters/seo/plus');
			$this->_urlSymbols['_'] = Mage::getStoreConfig('morphes_filters/seo/underscore');
			$this->_urlSymbols["'"] = Mage::getStoreConfig('morphes_filters/seo/quote');
			$this->_urlSymbols['"'] = Mage::getStoreConfig('morphes_filters/seo/double_quote');
			$this->_urlSymbols['%'] = Mage::getStoreConfig('morphes_filters/seo/percent');
            $this->_urlSymbols['#'] = Mage::getStoreConfig('morphes_filters/seo/hash');
            $this->_urlSymbols['&'] = Mage::getStoreConfig('morphes_filters/seo/ampersand');
            $this->_urlSymbols[' '] = Mage::getStoreConfig('morphes_filters/seo/space');
        }
		return $this;
	}
