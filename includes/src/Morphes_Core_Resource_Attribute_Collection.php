 ...
 *
 */
class Morphes_Core_Resource_Attribute_Collection extends Mage_Eav_Model_Mysql4_Entity_Attribute_Collection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(array('main_table' => $this->getResource()->getMainTable()))
            ...
            ->join(
                array('additional_table' => $this->getTable('morphes_core/attribute')),
