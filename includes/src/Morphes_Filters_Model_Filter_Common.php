 ...
 *
 */
class Morphes_Filters_Model_Filter_Common
{
    /**
     * @var Morphes_Filters_Interface_Filter_Model
     */
    protected $_model;

    public function __construct(Morphes_Filters_Interface_Filter_Model $model) {
        $this->_model = $model;
    }

    #region Morphes_Filters_Interface_Filter_Query methods
    /**
