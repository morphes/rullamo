...
/**
 * This resource model handles DB operations with a collection of models of type Morphes_Filters_Model_Filter2. All 
 * database specific code for operating collection of Morphes_Filters_Model_Filter2 should go here.
 * @author Morphes Team
 */
class Morphes_Filters_Resource_Filter2_Collection extends Morphes_Db_Resource_Object_Collection
{
    /**
