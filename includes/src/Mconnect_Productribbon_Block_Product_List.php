...
class Mconnect_Productribbon_Block_Product_List extends Mage_Catalog_Block_Product_List
{
    ...
    if(in_array($listSku, $Npc)){
        ...
        <?php if($currntDateintime >= $productDatetoTime && $currntDateintime <= $additionofDaysForNew){ ?>
                    <?php if($listmode == 'list'){ 
                          if($getpositionforNewproduct == 'top-left'){ ?>
                            <span class="label-new-top-left-list">
                        <?php } ?> 
                      
                        <?php if($getpositionforNewproduct == 'top-right'){ ?>
                                <span class="label-new-top-right-list" >
                            
                        <?php } ?>
                    
                        <?php if($getpositionforNewproduct == 'bottom-left'){ ?>
                                <span class="label-new-bottom-left-list" >
                            
                        <?php } ?>
                                    
                        <?php if($getpositionforNewproduct == 'bottom-right'){ ?>
                                <span class="label-new-bottom-right-list" >
                    ...
                    <?php if($listmode == 'grid'){
                            if($getpositionforNewproduct == 'top-left'){ ?>
                            <span class="label-new-top-left-grid">
                            <?php } ?> 
                               
                            <?php if($getpositionforNewproduct == 'top-right'){ ?>
                                <span class="label-new-top-right-grid" >
                            
                            <?php } ?>
                                
                            <?php if($getpositionforNewproduct == 'bottom-left'){ ?>
                                <span class="label-new-bottom-left-grid" >
                            
                            <?php } ?>
                                    
                            <?php if($getpositionforNewproduct == 'bottom-right'){ ?>
                                <span class="label-new-bottom-right-grid" >
                            
                            <?php }
                    
                            
                    } ?>    
                        <img alt="ribbon" title="ribbon" src="<?php echo Mage::getBaseUrl('media').'m-connectRibbon/'.$getnewproductsimagename ?>" class="imgribbon newpr"/>
       ...
       if(in_array($listSku, $Bpc)){ 
                  ...
                  ?>
                        ...
                        <img  alt="ribbon" title="ribbon"  src="<?php echo Mage::getBaseUrl('media').'m-connectRibbon/'.$getbestproductsimagename ?>" style="<?php if($adminStyleBest != ''){ echo $adminStyleBest; }else{ ?>height: 50px;width: 50px;<?php }?>" class="imgribbon bestpr"/>
                          </span>
                <?php
            }
           }
    ...
    if($specialSpricelabel != ''){ ?>
          ...
          <img  alt="ribbon" title="ribbon" src="<?php echo Mage::getBaseUrl('media').'m-connectRibbon/'.$getsalesproductsimagename ?>" class="imgribbon salespr"/>
                                </span>
              <?php
      }
    }
    ...
    public function ReviewProductImageOnProduct($listSku,$Rpc,$modelSku2,$currntDate,$adminDayForReviewproduct,$currntDateintime,$getreviewproductsimagename,$adminStyleReview,$getpositionforMostRiviewedproduct,$listmode){
     if(in_array($listSku, $Rpc)){ 
                  ...
                  ?>
                        ...
                        <img  alt="ribbon" title="ribbon" src="<?php echo Mage::getBaseUrl('media').'m-connectRibbon/'.$getreviewproductsimagename ?>" class="imgribbon reviewpr"/>
                                </span>
                            <?php
        }
       }
