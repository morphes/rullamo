...
class Flagbit_Faq_Block_Adminhtml_Item_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function __construct()
	{
		...
		$this->_updateButton('save', 'label', Mage::helper('flagbit_faq')->__('Сохранить Вопрос'));
		$this->_updateButton('delete', 'label', Mage::helper('flagbit_faq')->__('Удалить Вопрос'));
		
		$this->_addButton('saveandcontinue', array (
				'label' => Mage::helper('flagbit_faq')->__('Сохранить и продолжить редактирование'), 
	...
	public function getHeaderText()
	{
		if (Mage::registry('faq')->getFaqId()) {
			return Mage::helper('flagbit_faq')->__("Редактировать вопрос '%s'", $this->htmlEscape(Mage::registry('faq')->getQuestion()));
		}
		else {
			return Mage::helper('flagbit_faq')->__('Новый вопрос');
		}
	}
