...
/**
 * Generic helper functions for MorphesPro_FilterAdmin module. This class is a must for any module even if empty.
 * @author Morphes Team
 */
class MorphesPro_FilterAdmin_Helper_Data extends Mage_Core_Helper_Abstract {
