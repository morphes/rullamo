 ...
 *
 */
class MorphesPro_FilterSuperSlider_Model_Solr_Attribute extends Morphes_Filters_Model_Solr_Attribute {
    ...
    public function getExistingValues() {
        ...
        foreach ($this->getItems() as $item) {
            $urlValue = $item['value'];
            if (((string)Mage::getConfig()->getNode('modules/MorphesPro_FilterSeoLinks/active')) == 'true' &&
                Mage::helper('morphes_core')->getRoutePath() != 'catalogsearch/result/index')
            {
