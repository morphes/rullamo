 ...
 */
class Morphes_Filters_Model_Filter_Decimal
    ...
    implements Morphes_Filters_Interface_Filter
{
    ...
    {
        /* @var $ext Morphes_Filters_Helper_Extended */
        $ext = Mage::helper(strtolower('Morphes_Filters/Extended'));
    ...
    public function getRange()
    {
        ...
        if (!$range) {
            ...
            } elseif (Mage::helper('morphes_db')->hasOverriddenValueEx(
