 ...
 *
 */
class Morphes_Admin_Block_Crud_Detail_Serializer extends Mage_Adminhtml_Block_Template {
	protected function _construct() {
		$this->setTemplate('morphes/admin/grid/serializer.phtml');
		parent::_construct();
	}
	...
	protected function _getColumns() {
		...
		foreach ($this->getGrid()->getColumns() as /* @var $column Mage_Adminhtml_Block_Widget_Grid_Column */ $column) {
			if ($column->getRenderer() instanceof Morphes_Admin_Block_Column) {
