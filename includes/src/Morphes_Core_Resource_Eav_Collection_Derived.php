 ...
 *
 */
class Morphes_Core_Resource_Eav_Collection_Derived extends Morphes_Core_Resource_Eav_Collection {
    ...
    protected function _loadCustomItems() {
    	...
    	/* @var $collection Morphes_Core_Resource_Eav_Collection */ $collection = new $collection;
