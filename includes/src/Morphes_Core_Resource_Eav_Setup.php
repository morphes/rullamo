 ...
 *
 */
class Morphes_Core_Resource_Eav_Setup extends Mage_Eav_Model_Entity_Setup {
    protected function _prepareValues($attr)
    {
        $data = parent::_prepareValues($attr);
        $data = array_merge($data, array(
            'is_key'		   			=> $this->_getValue($attr, 'is_key', 0),
            'is_global'		   			=> $this->_getValue($attr, 'is_global', Morphes_Core_Model_Attribute_Scope::_GLOBAL),
