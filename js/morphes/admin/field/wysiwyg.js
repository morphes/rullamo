...
(function ($) {
    $(function () {
        $('.m-wysiwyg').live('click', function () {
            ...
            morphesWysiwygEditor.open($.options('#morphes-wysiwyg-editor').url, elementId, $.options('#morphes-wysiwyg-editor').storeId);
        });
    });
})(jQuery);
