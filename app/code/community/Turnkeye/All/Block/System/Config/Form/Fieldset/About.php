...
/**
 * About block on system configuration
 *
 * @category   Turnkeye
 * @package    Turnkeye_All
...
class Turnkeye_All_Block_System_Config_Form_Fieldset_About extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    protected function _getAboutHtml()
    {
        return $this->getLayout()
            ->createBlock('turnkeye_all/system_config_form_fieldset_about_fields')
            ->toHtml();
    }
}
