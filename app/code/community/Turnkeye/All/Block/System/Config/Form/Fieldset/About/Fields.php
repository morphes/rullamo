...
/**
 * About content block on system configuration
 *
 * @category   Turnkeye
 * @package    Turnkeye_All
...
class Turnkeye_All_Block_System_Config_Form_Fieldset_About_Fields extends Mage_Adminhtml_Block_Abstract
{
    ...
    {
        parent::_construct();
        $this->setTemplate('turnkeye/all/about.phtml');
    }
