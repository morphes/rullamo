...
INSERT INTO {$this->getTable('blog/blog')} (`post_id`, `title`, `post_content`, `status`, `created_time`, `update_time`, `identifier`, `user`, `update_user`, `meta_keywords`, `meta_description`, `comments`, `tags`, `short_content`) VALUES (NULL, 'Sample Blog Post', 'Sample Content', 1, NOW( ), NULL, 'sampleblogpost', 'Novaworks', 'Novaworks', '', '', 0, '', 'Sample Short Content');
