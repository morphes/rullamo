...
class Novaworks_Blog_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('Novaworks_Blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=Novaworks_Blog_main.post_id', array('Novaworks_Blog_main.title'));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('Novaworks_Blog_main.post_id', array(
