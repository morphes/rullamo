...
class Novaworks_Blog_Block_Menu_Sidebar extends Novaworks_Blog_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        if (self::$_helper->getEnabled()) {
            ...
            $isBlogPage = Mage::app()->getRequest()->getModuleName() == Novaworks_Blog_Helper_Data::DEFAULT_ROOT;
