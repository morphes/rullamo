...
abstract class Novaworks_Blog_Block_Abstract extends Mage_Core_Block_Template
{
    ...
    protected static $_catUriParam = Novaworks_Blog_Helper_Data::CATEGORY_URI_PARAM;
    
    protected static $_postUriParam = Novaworks_Blog_Helper_Data::POST_URI_PARAM;
    
    protected static $_tagUriParam = Novaworks_Blog_Helper_Data::TAG_URI_PARAM;
    ...
    {        
        ...
        foreach ($collection as $item) {
            ...
            if ($shortContent) {
                ...
                $strManager = new Novaworks_Blog_Helper_Substring(array('input' => self::$_helper->filterWYS($item->getPostContent())));
    ...
    {
        if (self::$_helper->conf(Novaworks_Blog_Helper_Data::XML_BOOKMARKS)) {
    ...
    {
        return Mage::app()->getRequest()->getModuleName() == Novaworks_Blog_Helper_Data::DEFAULT_ROOT;
    }
    ...
    protected function _prepareCollection()
    {
        if (!$this->getData('cached_collection')) {
            ...
            $collection = Mage::getModel('blog/blog')->getCollection()
                    ->addPresentFilter()
                    ->addEnableFilter(Novaworks_Blog_Model_Status::STATUS_ENABLED)
                    ->addStoreFilter()
                    ->joinComments()
