<?php
class Novaworks_CustomWidgets_Block_Adminhtml_System_Config_Form_Field_Imagessmall extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    {        
        $html = '<div class="left a-center novaworks-radio">';
	    $html .= '<div class="novaworks-thumb"><img src="'.Mage::getDesign()->getSkinUrl('images/'.$option['value'].'.png').'" /></div>';
