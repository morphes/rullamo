            ...
            if ($productId) {              
              ...
              //   }
                ...
                // try {
                    ...
                    if($this->getRequest()->getParam('add_to_cart')) { 
                        $cart->save();                       
                    }
            ...
            <div id='product-count'>
		     ...
		     &nbsp;
                ...
                <div id='product-count-input'>
                    <form action='/checkout/cart' method='POST' class='checkout_form'>
          		          <input type='text' id='count_cart' name='qty' value='1' onkeydown='maskInput()' onkeyup='changeHtml(".$price_product.",".Mage::getModel('cataloginventory/stock_item')->loadByProduct($productId)->getQty().", ".$price_product.")'/>
