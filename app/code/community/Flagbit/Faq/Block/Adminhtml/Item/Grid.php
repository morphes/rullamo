...
class Flagbit_Faq_Block_Adminhtml_Item_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('faq_id', array (
                'header' => Mage::helper('flagbit_faq')->__('Вопросы'), 
                'width' => '80px', 
                'type' => 'text', 
                'index' => 'faq_id' ));
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('store_id', 
                    array (
                            'header' => Mage::helper('cms')->__('Видимость в магазине'), 
                            'index' => 'store_id', 
                            'type' => 'store', 
                            'store_all' => true, 
                            'store_view' => true, 
        ...
        $this->addColumn('question', array (
                'header' => Mage::helper('flagbit_faq')->__('Вопрос'), 
                'index' => 'question' ));
              $this->addColumn('is_featured', 
                array (
                        'header' => Mage::helper('flagbit_faq')->__('Избранный?'), 
                        'index' => 'is_featured', 
                        'type' => 'options', 
                        'width' => '70px', 
                        'options' => array (
                                0 => Mage::helper('flagbit_faq')->__('Нет'), 
                                1 => Mage::helper('flagbit_faq')->__('Да') ) ));  
        $this->addColumn('is_active', 
                array (
                        'header' => Mage::helper('flagbit_faq')->__('Активен?'), 
                        'index' => 'is_active', 
                        'type' => 'options', 
                        'width' => '70px', 
                        'options' => array (
        ...
        $this->addColumn('action', 
                array (
                        ...
                        'actions' => array (
                                array (
                                        'caption' => Mage::helper('flagbit_faq')->__('Редактировать'), 
                                        'url' => array (
