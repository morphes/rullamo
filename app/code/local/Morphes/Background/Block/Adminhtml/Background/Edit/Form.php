<?php
class Morphes_Background_Block_Adminhtml_Background_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
...
/*******************Code to get values from table*********************/
    ...
    $fldInfo = $form->addFieldset('background_info', array('legend'=> $hlp->__('Описание')));
