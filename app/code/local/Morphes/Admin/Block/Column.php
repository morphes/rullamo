 ...
 *
 */
abstract class Morphes_Admin_Block_Column extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
...
$('<?php echo $cellId ?>').data(<?php echo $options->toJson() ?>);	
	...
	protected function _renderCellOptions($options, $row) {
		if ($this->getColumn()->hasDefaultBit()) {
			$options->setIsDefault(!Mage::helper('morphes_db')->hasOverriddenValue($row, null,
