 ...
 * @author Morphes Team
 * Injected instead of standard catalog/layer_filter_attribute in Morphes_Filters_Block_Filter_Attribute constructor.
 */
class Morphes_Filters_Model_Filter_Attribute
    ...
    implements Morphes_Filters_Interface_Filter
{
    ...
    protected function _getItemsData()
    {
        ...
        // MORPHES BEGIN: from url, retrieve ids of all options currently selected
        ...
        if ($data === null) {
            ...
            usort($data, array(Mage::getSingleton('morphes_filters/sort'), $sortMethod));
