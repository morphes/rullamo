 ...
 * @author Morphes Team
 * Injected instead of standard catalog/layer_filter_attribute in Morphes_Filters_Block_Filter_Category constructor.
 */
class Morphes_Filters_Model_Filter_Category
    ...
    implements Morphes_Filters_Interface_Filter
{
     ...
     * @return Morphes_Filters_Model_Filter_Category
     */
    public function addCountToCategories($categories, $products = null, $inCurrentCategory = false) {
        ...
        if (count($items)) {
            ...
            if (!$category->hasProductCount()) {
                Mage::helper('morphes_filters')->addCountToCategories($products, $categories, $inCurrentCategory);
            }
        }
        return $this;
    }
