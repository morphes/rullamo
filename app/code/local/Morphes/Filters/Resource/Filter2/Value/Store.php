...
/**
 * This resource model handles DB operations with a single model of type Morphes_Filters_Model_Filter2_Value_Store. All 
 * database specific code for Morphes_Filters_Model_Filter2_Value_Store should go here.
 * @author Morphes Team
 */
class Morphes_Filters_Resource_Filter2_Value_Store extends Morphes_Filters_Resource_Filter2_Value {
    /**
	...
	protected function _construct() {
        $this->_init(strtolower('Morphes_Filters/Filter2_Value_Store'), 'id');
        $this->_isPkAutoIncrement = false;
    }   
	protected function _getReplicationSources() {
		return array('morphes_filters/filter2_value', 'core/store', 'eav/attribute', 'morphes_filters/filter2_store');
	}
    /**
	...
	protected function _prepareReplicationUpdateSelects($target, $options) {
		...
		$select
			...
			->joinInner(array('parent' => Mage::getSingleton('core/resource')->getTableName('morphes_filters/filter2_store')), 
	...
	protected function _prepareReplicationInsertSelects($target, $options) {
		...
		$select
			...
			->joinInner(array('parent_global' => Mage::getSingleton('core/resource')->getTableName('morphes_filters/filter2')), 
