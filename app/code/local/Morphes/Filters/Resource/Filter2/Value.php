...
/**
 * This resource model handles DB operations with a single model of type Morphes_Filters_Model_Filter2_Value. All 
 * database specific code for Morphes_Filters_Model_Filter2_Value should go here.
 * @author Morphes Team
 */
class Morphes_Filters_Resource_Filter2_Value extends Morphes_Db_Resource_Object {
	...
	protected function _construct() {
        $this->_init(strtolower('Morphes_Filters/Filter2_Value'), 'id');
        $this->_isPkAutoIncrement = false;
    }   
	protected function _getReplicationSources() {
		return array('eav/attribute', 'morphes_filters/filter2');
	}
	/**
	...
	protected function _prepareReplicationUpdateSelects($target, $options) {
		...
		$select
			...
			->joinInner(array('parent' => Mage::getSingleton('core/resource')->getTableName('morphes_filters/filter2')), 
