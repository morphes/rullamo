...
/**
 * This resource model handles DB operations with a single model of type Morphes_Filters_Model_Filter2_Store. All 
 * database specific code for Morphes_Filters_Model_Filter2_Store should go here.
 * @author Morphes Team
 */
class Morphes_Filters_Resource_Filter2_Store extends Morphes_Filters_Resource_Filter2 {
    /**
	...
	protected function _construct() {
        $this->_init(strtolower('Morphes_Filters/Filter2_Store'), 'id');
        $this->_isPkAutoIncrement = false;
    }   
	protected function _getReplicationSources() {
		return array('morphes_filters/filter2', 'core/store', 'eav/attribute');
	}
	/**
