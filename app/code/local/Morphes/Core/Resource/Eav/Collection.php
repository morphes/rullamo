 ...
 *
 */
class Morphes_Core_Resource_Eav_Collection extends Mage_Eav_Model_Entity_Collection_Abstract {
    ...
    protected function _joinAttributeToSelect($method, $attribute, $tableAlias, $condition, $fieldCode, $fieldAlias)
    {
        ...
        if ($store_id != $this->getDefaultStoreId() && $attribute->getIsGlobal() != Morphes_Core_Model_Attribute_Scope::_GLOBAL) {
            /**
