...
{
    const CUSTOM_BLOCK_TEMPLATE = 'tm_custom_menu_%d';
    ...
    public function drawCustomMenuItem($category, $level = 0, $last = false)
    {
        ...
        if ($drawPopup)
        {
            $html[] = '<div id="menu' . $id . '" class="menu' . $active . '" onmouseover="tmShowMenuPopup(this, \'popup' . $id . '\');" onmouseout="tmHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')">';
        }
        else
        {
        ...
        if ($drawPopup)
        {
            ...
            $html[] = '<div id="popup' . $id . '" class="tm-custom-menu-popup" onmouseout="tmHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')">';
            // --- draw Sub Categories ---
