...
class TM_CustomMenu_Block_Toggle extends Mage_Core_Block_Template
{
    public function _prepareLayout()
    {
        ...
        $layout->getBlock('catalog.topnav')->setTemplate('custommenu/top.phtml');
        $head = $layout->getBlock('head');
        $head->addItem('skin_js', 'js/custommenu/custommenu.js');
        $head->addItem('skin_css', 'css/custommenu/custommenu.css');
    }
