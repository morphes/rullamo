...
class Freaks_Quotes_Block_Adminhtml_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        if ($quote->getId()) { 
            return Mage::helper('freaks_quotes')->__("Редактировать Город '%s'", Mage::getModel('directory/region')->load($quote->getName())->getName());
        } else {
            return Mage::helper('freaks_quotes')->__("Добавить новый город");
        }
    }
}
