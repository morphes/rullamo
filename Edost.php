...
if(isset($city_code)) {
		...
		if($dop_tarif_mag['result']) {
			$method = Mage::getModel('shipping/rate_result_method');
								...
								//$method->setCarrierTitle('Транспортная компания СДЭК ('.$dop_tarif_mag['result']['deliveryPeriodMin'].'-'.$dop_tarif_mag['result']['deliveryPeriodMax'].' дней)');
			...
			$method = Mage::getModel('shipping/rate_result_method');
								$method->setCarrier('edost');
								//$method->setCarrierTitle('Транспортная компания СДЭК ('.$dop_tarif_ekonom['result']['deliveryPeriodMin'].'-'.$dop_tarif_ekonom['result']['deliveryPeriodMax'].' дней)');
